...
if (imc < 18.5) {
    console.log(`Você está abaixo da faixa de peso ideal, imc: ${imc}`);
} else if (imc > 24.99) {
    console.log(`Você está acima da faixa de peso ideal, imc: ${imc}`);
} else {
    console.log(`Você está dentro da faixa de peso ideal, imc: ${imc}`);
}